...
document.addEventListener('DOMContentLoaded', function () {
        ...
        },
        {
          ...
          render: function () {
            return (
              ...
              '<a href="app-invoice-preview.html" data-bs-toggle="tooltip" class="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect waves-light" data-bs-placement="top" title="Preview Invoice"><i class="icon-base ri ri-eye-line icon-22px"></i></a>' +
              '<div class="dropdown">' +
  ...
  setTimeout(() => {
    const elementsToModify = [
      ...
      { selector: '.invoice_status .form-select', classToAdd: 'form-select-sm' },
      {
