            ...
            buttons: [
              {
                ...
                text: '<span class="d-flex align-items-center"><i class="icon-base ri ri-download-line icon-18px me-sm-2"></i> <span class="d-none d-sm-inline-block">Export</span></span>',
                buttons: [
                  {
                    extend: 'print',
