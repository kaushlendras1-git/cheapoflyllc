...
function attach24HourTimeListener(input) {
    ...
    function addTrainRow() {
        ...
        newRow.innerHTML = `
            ...
            <td><input type="text" class="form-control train_departure_station" style="width: 9rem;" name="train[${trainIndex}][departure_station]" placeholder="Departure Station"></td>
            ...
            <td><input type="text" class="form-control train_arrival_station" style="width: 9rem;" name="train[${trainIndex}][arrival_station]" placeholder="Arrival Station"></td>
