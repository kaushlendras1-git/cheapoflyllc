...
<head>
  ...
  <title>General Car Rental Terms and Conditions | FareTickets LLC</title>
...
<body class="tc__body">
  ...
  <header class="page-header">
    <a href="/" class="logo-link">
      <img src="{{ asset('assets/img/fare_logo.webp') }}" alt="Logo">
    </a>
    <a href="tel:+18443822225" class="header-tfn">
      <i class="fa-solid fa-phone"></i> Toll Free: <strong>+1-844-382-2225</strong>
    </a>
  </header>
  ...
  <div class="tc__wrapper">
    ...
    <p class="tc__text"><strong>Intermediary Role:</strong> FareTickets LLC acts as an <strong>intermediary</strong> between the customer and the car rental supplier. The rental agreement and terms of service are governed by the rental company providing the vehicle.</p>
    <p class="tc__text"><strong>Booking Confirmation:</strong> Car rental reservations are confirmed only once payment has been received and a confirmation voucher has been issued by FareTickets LLC.</p>
    ...
    <p class="tc__text"><strong>Late Pick-Up:</strong> Late arrivals may be accommodated at the supplier’s discretion, subject to vehicle availability and potential rebooking charges. If you anticipate a delay, inform us immediately at <strong>+1-844-382-2225.</strong></p>
    ...
    <p class="tc__text"><strong>Accepted Payments:</strong> FareTickets LLC accepts major credit, debit, and domestic cards for booking payments. Bookings made using domestic, international, or third-party cards may require additional verification, including:</p>
    <ul class="tc__list">
    ...
    <p class="tc__text"><strong>Payment Security:</strong> All payments processed through FareTickets LLC are protected by advanced encryption and fraud-prevention systems. In case of suspected fraud or unauthorized use, FareTickets LLC reserves the right to cancel the booking and refund verified payments after due verification.</p>
    ...
    <p class="tc__text"><u>Refundable Tickets:</u> Refundable rentals can be modified or cancelled prior to the scheduled pick-up date, subject to the supplier’s policy and FareTickets LLC service fees.</p>
    <p class="tc__text">Approved refunds will be processed after deducting applicable supplier penalties and FareTickets LLC handling charges.</p>
    ...
    <p class="tc__text"><strong>Important:</strong> All changes or cancellations must be processed through FareTickets LLC, <strong>not directly with the rental company.</strong> For assistance, contact our Travel Consultant at <strong>+1-844-382-2225.</strong></p>
    ...
    <p class="tc__text"><strong>Voluntary Add-ons:</strong> Renting or purchasing additional equipment or services is a <strong>voluntary decision made directly with the rental supplier.</strong> FareTickets LLC does not intervene and is not liable for any additional amounts you may be required to pay.</p>
    ...
    <p class="tc__text">FareTickets LLC is <strong>not responsible for disputes</strong> arising from changes, fees, or enforcement of the supplier’s individual policies.</p>

    <h2 class="tc__subtitle">9. Involuntary Changes</h2>
    <p class="tc__text">In the event of vehicle unavailability, breakdown, or booking cancellation initiated by the car rental supplier, <strong>FareTickets LLC </strong> will assist in arranging an alternative vehicle of similar category or processing applicable refunds as per the supplier’s policy.</p>
    <p class="tc__text"><strong>FareTickets LLC</strong> is not responsible for any additional costs resulting from such involuntary changes, including accommodation, meals, or alternate transportation expenses incurred by the traveller.</p>

    <h2 class="tc__subtitle">10. Privacy Policy</h2>
    <p class="tc__text">FareTickets LLC respects your privacy and is committed to protecting your personal information.</p>
    ...
    <div class="tc__contact">
      <p class="tc__text"><i class="fa-solid fa-phone"></i> <strong>Phone:</strong> +1-844-382-2225</p>
  ...
  <h2 class="tc__subtitle">1. General Conditions</h2>
  <p class="tc__text"><strong>Ticket Policy:</strong> All flight tickets issued by <strong>FareTickets LLC</strong> are generally <strong>non-refundable, non-transferable,</strong> and <strong>name changes are strictly not permitted.</strong></p>
  <p class="tc__text">However, FareTickets LLC offers two categories of airfare:</p>

  <ul class="tc__list">
    <li><strong>Refundable Tickets:</strong>
      <ul class="tc__list">
        <li>Refundable fares are subject to airline fare rules and FareTickets LLC’s service fee.</li>
  ...
  <p class="tc__text"><strong>Changes to Booking:</strong> Date or route changes are subject to applicable FareTickets LLC change fees and any fare differences based on current availability.</p>
  ...
  <p class="tc__text"><strong>Important:</strong> Any cancellations, amendments, or refund requests must be handled through FareTickets LLC and <strong>not directly with the Airline</strong>. For assistance, contact our Travel Consultant at <strong>+1-844-382-2225.</strong></p>
  ...
  <p class="tc__text"><strong>Liability:</strong> FareTickets LLC will not be responsible for denied boarding or entry due to incomplete or invalid documents.</p>
  ...
  <p class="tc__text"><strong>Flight Confirmation:</strong> Passengers are advised to reconfirm their flight details at least 72 hours prior to departure by contacting FareTickets LLC at <strong>+1-844-382-2225.</strong></p>
  ...
  <p class="tc__text"><strong>Accepted Payments:</strong> FareTickets LLC accepts all major credit, debit, and domestic payment cards.</p>
  ...
  <p class="tc__text">FareTickets LLC uses PCI DSS-compliant systems for secure credit card transactions.</p>
  <p class="tc__text">In case of suspicious or fraudulent activity, FareTickets LLC reserves the right to cancel the booking and refund the amount to the original payment method after necessary verification.</p>
  ...
  <p class="tc__text">FareTickets LLC shares the latest baggage details as per the airline’s policy. For confirmation or assistance, please contact our Travel Consultant at +1-844-382-2225.</p>
  ...
  <p class="tc__text">FareTickets LLC strongly recommends purchasing travel insurance for protection against trip cancellation, delays, lost baggage, or medical emergencies.</p>
  ...
  <p class="tc__text">FareTickets LLC will assist in submitting requests but cannot guarantee seat allocation or meal confirmation.</p>
  <p class="tc__text">Some airlines may charge additional fees for preferred seating or special meal requests. For assistance or details, please contact our Travel Consultant at +1-844-382-2225.</p>

  <h2 class="tc__subtitle">9. Involuntary Changes</h2>
  <p class="tc__text">In case of flight cancellations, delays, or schedule changes initiated by the airline, FareTickets LLC will assist in rebooking or obtaining applicable refunds as per the airline’s policy.</p>
  <p class="tc__text">FareTickets LLC is not responsible for costs arising from such involuntary changes, including accommodation, meals, or ground transportation.</p>

  <h2 class="tc__subtitle">10. Privacy Policy</h2>
  <p class="tc__text">FareTickets LLC respects your privacy and is committed to safeguarding your personal and payment information.</p>
...
<!-- Cruise Terms and Conditions -->
 <div class="tc__wrapper">
    ...
    <p class="tc__text"><strong>Intermediary Role:</strong> FareTickets LLC acts solely as an <strong>intermediary</strong> between customers and cruise lines or their authorized representatives. All bookings are subject to the individual <strong>cruise line’s rules, fare conditions, and terms of carriage.</strong></p>
    ...
    <p class="tc__text"><strong>Reservation Confirmation:</strong> A cruise reservation is confirmed only upon successful payment and issuance of a <strong>cruise confirmation or e-ticket.</strong> FareTickets LLC is not responsible for changes made by the cruise line after confirmation.</p>

    <p class="tc__text"><strong>Cruise Itineraries:</strong> Cruise itineraries are subject to change by the cruise line due to weather, port conditions, mechanical issues, or other operational factors. FareTickets LLC shall not be held liable for such changes.</p>

    <h2 class="tc__subtitle">2. Payment and Pricing Policy</h2>

    <p class="tc__text"><strong>Accepted Payments:</strong> FareTickets LLC accepts all major credit, debit, and domestic cards. Payments made using domestic, international, or third-party cards may require additional verification, including:</p>
    ...
    <ul class="tc__list">
      ...
      <li>Approved refunds will be processed after deducting applicable <strong>cruise line penalties and FareTickets LLC service charges.</strong> Refunds may take 7–30 business days depending on the cruise line and payment method.</li>
    </ul>
    ...
    <p class="tc__text"><strong>Important:</strong> All cancellations, amendments, or refund requests must be handled through FareTickets LLC and <strong>not directly with the cruise line.</strong> For assistance, contact our Travel Consultant at <strong>+1-844-382-2225.</strong></p>
    ...
    <p class="tc__text"><strong>Travel Restrictions:</strong> Failure to present proper documentation may result in denied boarding, and FareTickets LLC will not be liable for any associated costs or penalties.</p>
    ...
    <p class="tc__text"><strong>Personal Belongings:</strong> Cruise lines and FareTickets LLC are not responsible for loss or theft of personal items. Passengers are advised to carry <strong>travel insurance </strong> covering such risks.</p>
    ...
    <p class="tc__text"><strong>Third-Party Services:</strong> FareTickets LLC does not operate or control these services and <strong>is not liable for any issues</strong> or disputes arising from participation in such activities.</p>

    <p class="tc__text"><strong>Voluntary Add-Ons:</strong> The selection of additional services is a voluntary decision between the traveller`s and the cruise provider. FareTickets LLC is not responsible for resulting additional payments or service variations.</p>
    ...
    <p class="tc__text">FareTickets LLC does not sell or manage insurance but can provide guidance on third-party insurance providers upon request.</p>

    <h2 class="tc__subtitle">10. Involuntary Changes</h2>

    <p class="tc__text">FareTickets LLC is <strong>not responsible</strong> for any injury, delay, loss, damage, or expense arising from actions, negligence, or failures of the cruise line or other suppliers.</p>
    ...
    <p class="tc__text">FareTickets LLC’s liability is limited to the value of the booking made through our platform and does not extend beyond the terms agreed at purchase.</p>
  ...
  <!-- Hotels Terms and Conditions -->
     <div class="tc__wrapper">
        ...
        <p class="tc__text"><strong>Intermediary Role:</strong> FareTickets LLC acts solely as a booking intermediary between the customer and the hotel or accommodation provider. Your reservation is subject to the individual hotel's policies, rules, and terms of service.</p>

        <p class="tc__text"><strong>Booking Confirmation:</strong> A hotel booking is confirmed only once payment is successfully processed and a confirmation voucher has been issued by FareTickets LLC.</p>

        <p class="tc__text"><strong>Hotel Rating and Information:</strong> Star ratings, amenities, and images provided on our website are based on hotel-supplied information and industry standards. FareTickets LLC does not guarantee the accuracy of ratings or facilities.</p>
        ...
        <p class="tc__text">FareTickets LLC offers two categories of hotel bookings:</p>

        <p class="tc__text"><strong>a) Refundable Bookings</strong></p>

        <ul class="tc__list">
            <li>Refundable bookings may be cancelled or modified before the check-in date, subject to the property's policy and FareTickets LLC service fees.</li>
        ...
        <div class="note-box">
            <p class="tc__text"><strong>Important:</strong> Any request for cancellation or amendment must be submitted via FareTickets LLC and <strong>not directly with the hotel</strong>. For assistance, please contact our Travel Consultant at <strong>+1-844-382-2225</strong>.</p>
        </div>
        ...
        <ul class="tc__list">
            ...
            <li>Guests arriving later than the scheduled check-in time must inform FareTickets LLC in advance to avoid a no-show penalty.</li>
        </ul>

        <h2 class="tc__subtitle">5. Payment and Credit Card Authorization</h2>

        <ul class="tc__list">
            <li>FareTickets LLC accepts all major credit, debit, and domestic payment cards.</li>
        ...
        <ul class="tc__list">
            <li>FareTickets LLC uses PCI DSS-compliant systems for secure credit card transactions.</li>
            <li>In case of suspicious or fraudulent activity, FareTickets LLC reserves the right to cancel the booking and refund the amount to the original payment method after necessary verification.</li>
        </ul>
        ...
        <ul class="tc__list">
            ...
            <li><strong>Voluntary Add-ons:</strong> The hiring or purchase of such additional services is a <strong>voluntary arrangement between you and the hotel</strong>. FareTickets LLC does not intervene and is <strong>not liable</strong> for any additional amounts or service variations.</li>
            <li>FareTickets LLC provides information as per the hotel's current policy; travellers are advised to verify details with our team before travel.</li>
        </ul>
        ...
        <ul class="tc__list">
            <li>In the event of hotel overbooking, closure, or any changes initiated by the property, <strong>FareTickets LLC</strong> will assist in arranging alternative accommodation of similar category or processing applicable refunds as per the hotel's policy.</li>
            <li><strong>FareTickets LLC</strong> is not responsible for any additional expenses resulting from such involuntary changes, including transportation, meals, or incidental costs incurred by the traveller.</li>
            <li>FareTickets LLC will assist to the best of its ability but is <strong>not responsible for compensation or losses</strong> resulting from hotel relocation decisions.</li>
        </ul>
    ...
    <!-- Train Terms and Conditons -->
      <div class="tc__wrapper">
        ...
        <ul class="tc__list">
            <li><strong>Intermediary Role:</strong> FareTickets LLC acts solely as an <strong>intermediary</strong> between customers and railway operators or authorized ticket distributors. All bookings are governed by the <strong>respective rail operator's terms, fare rules, and travel policies</strong>.</li>
        ...
        <ul class="tc__list">
            <li><strong>Accepted Payments:</strong> FareTickets LLC accepts all major credit, debit, and domestic payment cards.</li>
            ...
            <li><strong>Currency:</strong> All fares are processed in the currency specified at booking. FareTickets LLC is not responsible for fluctuations in exchange rates or currency conversion fees.</li>
        ...
        <ul class="tc__list">
            <li>Refundable train tickets may be cancelled or modified before departure, subject to the carrier's policy and FareTickets LLC service fees.</li>
            <li>Approved refunds will be processed after deducting applicable operator penalties and FareTickets LLC processing fees.</li>
        ...
        <div class="note-box">
            <p class="tc__text"><strong>Important:</strong> Any cancellations, amendments, or refund requests must be handled through FareTickets LLC and <strong>not with the train operator</strong>. For assistance, contact our Travel Consultant at <strong>+1-844-382-2225</strong>.</p>
        </div>
        ...
        <ul class="tc__list">
            ...
            <li><strong>Missed Connections:</strong> FareTickets LLC is not responsible for missed connections caused by delays in other modes of transportation.</li>
        </ul>
        ...
        <ul class="tc__list">
            ...
            <li><strong>Lost or Damaged Luggage:</strong> FareTickets LLC is not liable for lost or damaged luggage. Claims must be made directly with the railway company.</li>
        ...
        <ul class="tc__list">
            ...
            <li><strong>Voluntary Services:</strong> Purchasing these services is a <strong>voluntary agreement between you and the railway company</strong>. FareTickets LLC does not intervene and is <strong>not liable for additional costs or service quality</strong>.</li>
        ...
        <ul class="tc__list">
            ...
            <li><strong>Responsibility:</strong> FareTickets LLC is not responsible for delays, cancellations, or disruptions caused by the rail operator.</li>
        ...
        <ul class="tc__list">
            <li>FareTickets LLC serves only as an intermediary and does not operate trains or control rail services.</li>
        ...
        <ul class="tc__list">
            ...
            <li>FareTickets LLC does not provide insurance but can recommend external providers upon request.</li>
        </ul>
        ...
        <ul class="tc__list">
            ...
            <li>In such cases, FareTickets LLC will assist in arranging rebooking or refunds in line with the train operator's policy.</li>
            <li>FareTickets LLC is not responsible for any additional costs, such as hotel stays or alternate transportation, resulting from such changes.</li>
        </ul>
  ...
  <footer class="page-footer">
    ...
    <p class="tc__copy">© 2025 FareTickets LLC. All Rights Reserved.</p>
  </footer>
