...
@if($booking_type->contains('type', 'Car'))
  <div class="tc__wrapper">   
    ...
    For details, visit our <strong>Privacy Policy</strong> at <a href="https://www.{{ $merchant->name }}.com/privacy-policy.php" target="_blank">https://www.{{ $merchant->name }}.com/privacy-policy.php</a></p>
    ...
    <div class="tc__contact">
      ...
      <p class="tc__text"><i class="fa-solid fa-envelope"></i> <strong>Email:</strong>{{ 'support@' . $merchant->name . '.com' }}</p>
      <p class="tc__text"><i class="fa-solid fa-globe"></i> <strong>Website:</strong> www.{{ $merchant->name }}.com</p>
...
@endif
  ...
  <p class="tc__text">All payment data is processed through PCI-compliant and encrypted systems. For details, visit our Privacy Policy at 
    <a href="https://www.{{ $merchant->name }}.com/privacy-policy.php" target="_blank">https://www.{{ $merchant->name }}.com/privacy-policy.php</a>
  </p>
...
<!-- Cruise Terms and Conditions -->
 ...
 <div class="tc__wrapper">  
    ...
    <p class="tc__text">All payment data is processed through PCI-compliant and encrypted systems.
    For details, visit our <strong>Privacy Policy</strong> at https://www.{{ $merchant->name }}.com/privacy-policy.php</p>
  ...
  <!-- Hotels Terms and Conditions -->
   @if($booking_type->contains('type', 'Hotel'))
     <div class="tc__wrapper">      
        ...
        <p class="tc__text">For details, visit our <strong>Privacy Policy</strong> at <a href="https://www.{{ $merchant->name }}.com/privacy-policy.php">https://www.{{ $merchant->name }}.com/privacy-policy.php</a></p>
...
<p class="tc__text">
    For details, visit our <strong>Privacy Policy</strong> at
       {{ 'https://www.' . $merchant->name . '.com/privacy-policy.php' }}
        ...
        <div class="tc__contact">
           ...
           <p class="tc__text"><strong>Customer Support (Available 24/7):</strong></p>
      <p class="tc__text"><i class="fa-solid fa-phone"></i> <strong>Phone:</strong> {{ $merchant->phone }}</p>
      <p class="tc__text"><i class="fa-solid fa-envelope"></i> <strong>Email:fd</strong> {{ 'support@' . $merchant->name . '.com' }}</p>
      <p class="tc__text"><i class="fa-solid fa-globe"></i> <strong>Website:</strong> www.{{ $merchant->name }}.com</p>
