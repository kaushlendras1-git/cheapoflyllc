...
@section('content')
              ...
              <div class="row gy-6">
                  ...
                  <div class="col-12">
                    <div class="card p-4 dark-header">
                      <h6 class="fw-bold mb-1 text-white">call-types</h6>
                      ...
                      <div class="d-flex flex-wrap gap-3 align-items-end">
                        ...
                        <div class="ms-auto d-flex gap-2">
                          ...
                          <!-- Add Button -->
                          <a href="{{route('call-types.create')}}" type="button" class="btn btn-info px-4 py-3 d-flex align-items-center gap-1 waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Add New Entry">
    ...
    @forelse($call_types as $call_type)
        <tr>
            ...
            <td>
                <!-- Edit button -->
                <a href="{{ route('call-types.edit', $call_type->id) }}" class="btn btn-warning btn-sm">Edit</a>

                <!-- Delete button -->
                <form action="{{ route('call-types.destroy', $call_type->id) }}" method="POST" style="display:inline-block;">
                    @csrf
                    @method('DELETE')
    ...
    @empty
        <tr>
            <td colspan="4" class="text-center">No call types available.</td> <!-- Adjusted colspan to 4 to match the number of columns -->
        </tr>
    @endforelse
    </tbody>
</table>
