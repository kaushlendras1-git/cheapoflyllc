...
@section('content')
              ...
              <div class="row gy-6">
                  ...
                  <div class="col-12">
                    <div class="card p-4 dark-header">
                      <h6 class="fw-bold mb-1 text-white">Teams</h6>
                      ...
                      <div class="d-flex flex-wrap gap-3 align-items-end">
                        ...
                        <div class="ms-auto d-flex gap-2">
                          ...
                          <!-- Add Button -->
                          <a href="{{route('teams.create')}}" type="button" class="btn btn-info px-4 py-3 d-flex align-items-center gap-1 waves-effect waves-light" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Add New Entry">
    ...
    @empty
        <tr>
            <td colspan="4" class="text-center">No teams available.</td> <!-- Adjusted colspan to 4 to match the number of columns -->
        </tr>
    @endforelse
    </tbody>
</table>
