            ...
            <div class="card p-4">
                <form method="GET" action="{{ route('payment-status.index') }}"
                    ...
                    <div class="add-follow-btn">
                        <a href="{{route('payment-status.create')}}" type="button"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Delete button -->
                                    <form action="{{ route('payment-status.destroy', $paymentStatuse->id) }}" method="POST"
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="text-center">No payment status available.</td>
