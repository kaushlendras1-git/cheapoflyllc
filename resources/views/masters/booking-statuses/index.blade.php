    ...
    <div class="upper-titles d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="breadcrumb">
               <a class="active" href="{{ route('user.dashboard') }}">Dashboard</a>
                <a class="active" aria-current="page">Booking Status</a>
        </div>
    </div>
    <div class="row gy-6">
        <!-- Filter Card -->
            ...
            <div class="card p-4">
                <form method="GET" action="{{ route('booking-status.index') }}"
                    ...
                    <div class="add-follow-btn">
                        <a href="{{route('booking-status.create')}}" type="button"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Delete button -->
                                    <form action="{{ route('booking-status.destroy', $bookingStatuse->id) }}" method="POST"
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="text-center">No booking status available.</td>
