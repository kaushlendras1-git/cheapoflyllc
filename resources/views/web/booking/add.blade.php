...
<form id="bookingForm" action="{{ route('travel.bookings.submit') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="upper-titles d-flex align-items-center justify-content-between mb-3">
        <h2 class="mb-0">Add Booking</h2>
            ...
            <div class="card p-4 create-booking-wrapper">
                        ...
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            <div class="form-check form-check-inline position-relative">
                                <input name="booking-type[]" class="form-check-input toggle-tab" type="checkbox"
                                    ...
                                    {{ in_array('Flight', old('booking-type', ['Flight'])) ? 'checked' : '' }}>
                                <label class="form-check-label position-relative" for="booking-flight">Flight</label>
                            </div>
                            <div class="form-check form-check-inline position-relative">
                                <input name="booking-type[]" class="form-check-input toggle-tab" type="checkbox"
                                    id="booking-hotel" value="Hotel"
                                    {{ in_array('Hotel', old('booking-type', [])) ? 'checked' : '' }}>
                                <label class="form-check-label position-relative" for="booking-hotel">Hotel</label>
                            </div>
                            <div class="form-check form-check-inline position-relative">
                                <input name="booking-type[]" class="form-check-input toggle-tab" type="checkbox"
                                    id="booking-cruise" value="Cruise"
                                    {{ in_array('Cruise', old('booking-type', [])) ? 'checked' : '' }}>
                                <label class="form-check-label position-relative" for="booking-cruise">Cruise</label>
                            </div>
                            <div class="form-check form-check-inline position-relative">
                                <input name="booking-type[]" class="form-check-input toggle-tab" type="checkbox"
                                    id="booking-car" value="Car"
                                    {{ in_array('Car', old('booking-type', [])) ? 'checked' : '' }}>
                                <label class="form-check-label position-relative" for="booking-car">Car</label>
                            </div>
                            <div class="form-check form-check-inline position-relative">
                                <input name="booking-type[]" class="form-check-input toggle-tab" type="checkbox"
                                    id="booking-train" value="Train"
                                    {{ in_array('Train', old('booking-type', [])) ? 'checked' : '' }}>
                                <label class="form-check-label position-relative" for="booking-train">Train</label>
                            </div>
                        </div>
                ...
                <div class="pt-5 ps-0">
                    <div class="row booking-form">
                        ...
                        <div class="col-md-2 position-relative mb-4" id="hotel-inputs">
                            <label class="form-label">Hotel Ref</label>
                            <input type="text" class="form-control" name="hotel_ref" value="{{ old('hotel_ref', '') }}"
                                placeholder="Hotel Ref">
                        </div>
                        <div class="col-md-2 position-relative mb-4" id="cruise-inputs">
                            <label class="form-label">Cruise Ref</label>
                            <input type="text" class="form-control" name="cruise_ref"
                                value="{{ old('cruise_ref', '') }}" placeholder="Cruise Ref">
                        </div>
                        <div class="col-md-2 position-relative mb-4" id="car-inputs">
                            <label class="form-label">Car Ref</label>
                            <input type="text" class="form-control" name="car_ref" value="{{ old('car_ref', '') }}"
                                placeholder="Car Ref">
                        </div>
                        <div class="col-md-2 position-relative mb-4" id="train-inputs">
                            <label class="form-label">Train Ref</label>
                            <input type="text" class="form-control" name="train_ref" value="{{ old('train_ref', '') }}"
                                placeholder="Train Ref">
                        </div>
                        <div class="col-md-2 position-relative mb-4">
                                    ...
                                    <tr class="passenger-form" data-index="0">
                                        ...
                                        <td>
                                            <select class="form-control" style="width:7.5rem"
                                                name="passenger[0][passenger_type]">
                                                <option value="">Select</option>
                                                <option value="Adult"
                                                    {{ old('passenger.0.passenger_type') === 'Adult' ? 'selected' : '' }}>
                                                    Adult</option>
                                                <option value="Child"
                                                    {{ old('passenger.0.passenger_type') === 'Child' ? 'selected' : '' }}>
                                                    Child</option>
                                                <option value="Infant"
                                                    {{ old('passenger.0.passenger_type') === 'Infant' ? 'selected' : '' }}>
                                                    Infant</option>
                                                <option value="Seat Infant"
                                                    {{ old('passenger.0.passenger_type') === 'Seat Infant' ? 'selected' : '' }}>
                                                    Seat Infant</option>
                                                <option value="Lap Infant"
                                                    {{ old('passenger.0.passenger_type') === 'Lap Infant' ? 'selected' : '' }}>
                                                    Lap Infant</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select class="form-control" style="width: 60px;"
                                                ...
                                                <option value="">Select</option>
                                                <option value="Male"
                                                    {{ old('passenger.0.gender', 'Male') === 'Male' ? 'selected' : '' }}>
                                                    Male</option>
                                                <option value="Female"
                                                    {{ old('passenger.0.gender') === 'Female' ? 'selected' : '' }}>
                                                    Female</option>
                                            </select>
                                        </td>
                                        <td>
                                            <select class="form-control" style="width:7.5rem"
                                                name="passenger[0][title]">
                                                <option value="">Select</option>
                                                <option value="Mr"
                                                    {{ old('passenger.0.title', 'Ms') === 'Mr' ? 'selected' : '' }}>Mr
                                                </option>
                                                <option value="Mrs"
                                                    {{ old('passenger.0.title', 'Ms') === 'Mrs' ? 'selected' : '' }}>Mrs
                                                </option>
                                                <option value="Ms"
                                                    {{ old('passenger.0.title', 'Ms') === 'Ms' ? 'selected' : '' }}>Ms
                                                </option>
                                                <option value="Master"
                                                    {{ old('passenger.0.title', 'Ms') === 'Master' ? 'selected' : '' }}>
                                                    Master</option>
                                                <option value="Miss"
                                                    {{ old('passenger.0.title', 'Ms') === 'Miss' ? 'selected' : '' }}>
                                                    Miss</option>
                                            </select>
                                        </td>
                                        ...
                                        <td>
                                            <input type="text" style="width:7.5rem" class="form-control"
                                                name="passenger[0][first_name]" placeholder="First Name">
                                        </td>
                                        <td>
                                            <input type="text" style="width:7.5rem" class="form-control"
                                                name="passenger[0][middle_name]" placeholder="Middle Name">
                                        </td>
                                        <td>
                                            <input type="text" style="width:7.5rem" class="form-control"
                                                name="passenger[0][last_name]" placeholder="Last Name">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" style="width:7.5rem" class="form-control"
                                                name="passenger[0][seat_number]" placeholder="Seat">
                                        </td>
                                        <td>
                                            <input type="number" style="width:7.5rem" class="form-control"
                                                name="passenger[0][credit_note]" placeholder="0" step="0.01">
                                        </td>
                                        <td>
                                            <input type="text" style="width:7.5rem" class="form-control"
                                                name="passenger[0][e_ticket_number]" placeholder="E Ticket">
                                        </td>
                                        <td>
                                            <button type="button"
                ...
                <div class="tab-pane fade " id="remarks" role="tabpanel" aria-labelledby="remarks-tab">
                    <div class="card pt-0 p-4">
                        ...
                        <div class="card-body p-0">
                            <textarea class="form-control mb-4" name="particulars" rows="4"
                                placeholder="Enter remarks here...">{{ old('particulars', '') }}</textarea>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="billing-table table">
                                    ...
                                    <tbody id="billingForms">
                                        <tr class="billing-card" data-index="0">
                                            <td>
                                                <h6 class="billing-card-title mb-0"> 1</h6>
                                            </td>
                                            <td>
                                                <select style="width:7.5rem" class="form-control"
                                                    name="billing[0][card_type]">
                                                    <option value="">Select</option>
                                                    <option value="VISA"
                                                        {{ old('billing.0.card_type', 'VISA') === 'VISA' ? 'selected' : '' }}>
                                                        VISA</option>
                                                    <option value="Mastercard"
                                                        {{ old('billing.0.card_type') === 'Mastercard' ? 'selected' : '' }}>
                                                        Mastercard</option>
                                                    <option value="AMEX"
                                                        {{ old('billing.0.card_type') === 'AMEX' ? 'selected' : '' }}>
                                                        AMEX</option>
                                                    <option value="DISCOVER"
                                                        {{ old('billing.0.card_type') === 'DISCOVER' ? 'selected' : '' }}>
                                                        DISCOVER</option>
                                                </select>
                                            </td>

                                            <td><input type="text" style="width:7.5rem" class="form-control"
                                                    placeholder="CC Number" name="billing[0][cc_number]"></td>
                                            <td><input type="text" style="width:10rem" class="form-control"
                                                    placeholder="CC Holder Name" name="billing[0][cc_holder_name]"></td>

                                            <td>
                                                <select class="form-control" style="width:7.5rem"
                                                    name="billing[0][exp_month]">
                                                    <option value="">MM</option>
                                                    <option value="01"
                                                        {{ old('billing.0.exp_month', '01') === '01' ? 'selected' : '' }}>
                                                        01</option>
                                                    <option value="02"
                                                        {{ old('billing.0.exp_month') === '02' ? 'selected' : '' }}>02
                                                    </option>
                                                    <option value="03"
                                                        {{ old('billing.0.exp_month') === '03' ? 'selected' : '' }}>03
                                                    </option>
                                                    <option value="04"
                                                        {{ old('billing.0.exp_month') === '04' ? 'selected' : '' }}>04
                                                    </option>
                                                    <option value="05"
                                                        {{ old('billing.0.exp_month') === '05' ? 'selected' : '' }}>05
                                                    </option>
                                                    <option value="06"
                                                        {{ old('billing.0.exp_month') === '06' ? 'selected' : '' }}>06
                                                    </option>
                                                    <option value="07"
                                                        {{ old('billing.0.exp_month') === '07' ? 'selected' : '' }}>07
                                                    </option>
                                                    <option value="08"
                                                        {{ old('billing.0.exp_month') === '08' ? 'selected' : '' }}>08
                                                    </option>
                                                    <option value="09"
                                                        {{ old('billing.0.exp_month') === '09' ? 'selected' : '' }}>09
                                                    </option>
                                                    <option value="10"
                                                        {{ old('billing.0.exp_month') === '10' ? 'selected' : '' }}>10
                                                    </option>
                                                    <option value="11"
                                                        {{ old('billing.0.exp_month') === '11' ? 'selected' : '' }}>11
                                                    </option>
                                                    <option value="12"
                                                        {{ old('billing.0.exp_month') === '12' ? 'selected' : '' }}>12
                                                    </option>
                                                </select>
                                            </td>
                                            ...
                                            <td>
                                                <select class="form-control" style="width:7.5rem"
                                                    name="billing[0][exp_year]">
                                                    <option value="">YYYY</option>
                                                    <option value="2024"
                                                        {{ old('billing.0.exp_year', '2024') === '2024' ? 'selected' : '' }}>
                                                        2024</option>
                                                    <option value="2025"
                                                        {{ old('billing.0.exp_year') === '2025' ? 'selected' : '' }}>
                                                        2025</option>
                                                    <option value="2026"
                                                        {{ old('billing.0.exp_year') === '2026' ? 'selected' : '' }}>
                                                        2026</option>
                                                    <option value="2027"
                                                        {{ old('billing.0.exp_year') === '2027' ? 'selected' : '' }}>
                                                        2027</option>
                                                    <option value="2028"
                                                        {{ old('billing.0.exp_year') === '2028' ? 'selected' : '' }}>
                                                        2028</option>
                                                    <option value="2029"
                                                        {{ old('billing.0.exp_year') === '2029' ? 'selected' : '' }}>
                                                        2029</option>
                                                    <option value="2030"
                                                        {{ old('billing.0.exp_year') === '2030' ? 'selected' : '' }}>
                                                        2030</option>
                                                    <option value="2031"
                                                        {{ old('billing.0.exp_year') === '2031' ? 'selected' : '' }}>
                                                        2031</option>
                                                    <option value="2032"
                                                        {{ old('billing.0.exp_year') === '2032' ? 'selected' : '' }}>
                                                        2032</option>
                                                    <option value="2033"
                                                        {{ old('billing.0.exp_year') === '2033' ? 'selected' : '' }}>
                                                        2033</option>
                                                    <option value="2034"
                                                        {{ old('billing.0.exp_year') === '2034' ? 'selected' : '' }}>
                                                        2034</option>
                                                </select>
                                            </td>

                                            <td><input type="text" style="width:7.5rem" class="form-control"
                                                    placeholder="CVV" name="billing[0][cvv]"></td>
                                            <td><input type="text" style="width:7.5rem" class="form-control"
                                                    placeholder="Address" name="billing[0][address]"></td>
                                            <td><input type="email" style="width:7.5rem" class="form-control"
                                                    placeholder="Email" name="billing[0][email]"></td>
                                            <td><input type="text" style="width:7.5rem" class="form-control"
                                                    placeholder="Contact No" name="billing[0][contact_no]"></td>
                                            <td><input type="text" style="width:7.5rem" class="form-control"
                                                    placeholder="City" name="billing[0][city]"></td>

                                            <td>
                                                <select id="country-0" style="width:9rem"
                                                    class="form-control country-select" name="billing[0][country]">
                                                    <option value="">Select Country</option>
                                                </select>
                                            </td>
                                            <td>
                                                <select id="state-0" style="width:7.5rem"
                                                    class="form-control state-select" name="billing[0][state]">
                                                    <option value="">Select State</option>
                                                </select>
                                            </td>

                                            <td><input type="text" style="width:7.5rem" class="form-control"
                                                    placeholder="ZIP Code" name="billing[0][zip_code]"></td>

                                            <td>
                                                <select class="form-control" style="width:7.5rem"
                                                    name="billing[0][currency]">
                                                    <option value="">Select Currency</option>
                                                    <option value="USD"
                                                        {{ old('billing.0.currency', 'USD') === 'USD' ? 'selected' : '' }}>
                                                        USD</option>
                                                    <option value="CAD"
                                                        {{ old('billing.0.currency') === 'CAD' ? 'selected' : '' }}>CAD
                                                    </option>
                                                    <option value="EUR"
                                                        {{ old('billing.0.currency') === 'EUR' ? 'selected' : '' }}>EUR
                                                    </option>
                                                    <option value="GBP"
                                                        {{ old('billing.0.currency') === 'GBP' ? 'selected' : '' }}>GBP
                                                    </option>
                                                    <option value="AUD"
                                                        {{ old('billing.0.currency') === 'AUD' ? 'selected' : '' }}>AUD
                                                    </option>
                                                    <option value="INR"
                                                        {{ old('billing.0.currency') === 'INR' ? 'selected' : '' }}>INR
                                                    </option>
                                                    <option value="MXN"
                                                        {{ old('billing.0.currency') === 'MXN' ? 'selected' : '' }}>MXN
                                                    </option>
                                                </select>
                                            </td>

                                            <td><input type="number" style="width:7.5rem" class="form-control"
                                                    placeholder="0.00" name="billing[0][amount]" value="0" step="0.01">
                                            </td>
