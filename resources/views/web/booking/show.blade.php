        ...
        <div class="card p-4 create-booking-wrapper">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div class="d-flex" style="font-size: 12px;">
                    <strong style="color: #1a3c5e; font-weight: 700; margin-right: 5px;">Sales:</strong><span
                        style="color: #2c3e50; margin-right: 20px;">Roger</span>
                    <strong style="color: #1a3c5e; font-weight: 700; margin-right: 5px;">Changes:</strong><span
                        style="color: #2c3e50; margin-right: 20px;">Zee</span>
                    <strong style="color: #1a3c5e; font-weight: 700; margin-right: 5px;">Billing:</strong><span
                        style="color: #2c3e50; margin-right: 20px;">Mark</span>
                    <strong style="color: #1a3c5e; font-weight: 700; margin-right: 5px;">Quality:</strong><span
                        style="color: #2c3e50; margin-right: 20px;">Smith</span>
                    <strong style="color: #1a3c5e; font-weight: 700; margin-right: 5px;">Issued On:</strong><span
                        style="color: #2c3e50; margin-right: 20px;">12 July 2025</span>
                    <strong style="color: #1a3c5e; font-weight: 700; margin-right: 5px;">Shared :</strong><span
                        style="color: #2c3e50;margin-right: 20px;">Agent</span>
                    <strong style="color: #1a3c5e; font-weight: 700; margin-right: 5px;">Booking :</strong><span
                        style="color: #2c3e50;margin-right: 20px;">{{$booking->id}}</span>
                    <strong style="color: #1a3c5e; font-weight: 700; margin-right: 5px;">Qc Score :</strong><span
                        style="color: #2c3e50;margin-right: 20px;">78%</span>
                    <strong style="color: #1a3c5e; font-weight: 700; margin-right: 5px;">Qc Status :</strong><span
                        style="color: #2c3e50;">Approved</span>
                </div>
        ...
        <ul class="nav nav-tabs tabs-booked" id="bookingTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="billing-tab" data-bs-toggle="tab" href="#billing" role="tab"
                    ...
                    <i class="ri ri-bank-line" style="font-size: 28px; color: #2e8b57;" title="Billing"></i>
                </a>
            </li>
