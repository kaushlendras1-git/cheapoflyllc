                            ...
                            <table class="passenger-table table">
                                ...
                                <tbody id="passengerForms">
                                    ...
                                    <tr class="passenger-form" data-index="{{$key}}">
                                        ...
                                        <td>
                                            <input type="text" style="width:7.5rem" class="form-control"
                                                name="passenger[{{$key}}][middle_name]"
                                                value="{{$passengers->middle_name}}" placeholder="Middle Name">
                                        </td>
                                        <td>
                                            <input type="text" style="width:7.5rem" class="form-control"
                                        ...
                                        <td>
                                            <button type="button"
                                                class="btn btn-sm btn-outline-danger delete-passenger">
                                        ...
                                        <tbody id="cruiseForms">
                                            ...
                                            <tr class="cruise-row" data-index="{{$key}}">
                                                ...
                                                <td><input type="time" class="form-control" style="width:50px"
                                                        ...
                                                        value="{{$travelCruise->departure_hrs}}" placeholder="Hrs"
                                                        min="0" max="23"></td>


                                                <td><input type="text" class="form-control" style="width:7.5rem"
                                                        name="cruise[{{$key}}][arrival_port]"
                                                        value="{{$travelCruise->arrival_port}}"
                                                ...
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-outline-danger delete-cruise-btn">
                                                        <i class="ri ri-delete-bin-line"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        ...
                                        <tbody id="hotelForms">
                                            ...
                                            <tr class="hotel-row" data-index="{{$key}}">
                                                ...
                                                <td><input type="text" class="form-control" style="width:8rem"
                                                        ...
                                                        value="{{$travelHotel->room_category}}"
                                                ...
                                                <td><input type="text" class="form-control" style="width:8rem"
                                                        ...
                                                        value="{{$travelHotel->hotel_address}}"
                                                        placeholder="Hotel Address">
                                                </td>
                                                <td><input type="text" class="form-control" style="width:7.5rem"
                                                        name="hotel[{{$key}}][remarks]"
                                                        value="{{$travelHotel->remarks}}" placeholder="Remarks"></td>
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-outline-danger delete-hotel-btn">
                                                        <i class="ri ri-delete-bin-line"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        ...
                                        <tbody id="trainForms">
                                            ...
                                            <tr class="train-row" data-index="{{$key}}">
                                                ...
                                                <td><input type="text" class="form-control" style="width: 7.5rem;"
                                                        ...
                                                        value="{{$trainBookingDetails->direction}}"
                                                ...
                                                <td><input type="number" class="form-control" style="width: 58px;"
                                                        ...
                                                        value="{{$trainBookingDetails->departure_hours}}"
                                                        placeholder="Hrs" min="0" max="23"></td>
                                                <td><input type="number" class="form-control" style="width: 58px;"
                                                        name="train[{{$key}}][departure_minutes]"
                                                        value="{{$trainBookingDetails->departure_minutes}}"
                                                ...
                                                <td><input type="number" class="form-control" style="width: 7.5rem;"
                                                        ...
                                                        value="{{$trainBookingDetails->arrival_hours}}"
                                                        placeholder="Hrs" min="0" max="23"></td>
                                                <td><input type="number" class="form-control" style="width: 7.5rem;"
                                                        name="train[{{$key}}][arrival_minutes]"
                                                        value="{{$trainBookingDetails->arrival_minutes}}"
                                                        placeholder="mm" min="0" max="59"></td>
                                                <td><input type="text" class="form-control" style="width: 7.5rem;"
                                                        name="train[{{$key}}][duration]"
                                                        value="{{$trainBookingDetails->duration}}"
                                                ...
                                                <td>
                                                    <button type="button"
                                                        class="btn btn-outline-danger delete-train-btn">
                                                        <i class="ri ri-delete-bin-line"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        ...
                                        <tbody id="billingForms">
                                            ...
                                            <tr class="billing-card" data-index="{{$key}}">
                                                ...
                                                <td><input style="width: 57px;" inputmode="numeric" maxlength="4"
                                                        ...
                                                        name="billing[{{$key}}][cvv]" value="{{$billingDetails->cvv}}">
                                                </td>
                                            ...
                                            <td>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button"
                                                        class="btn btn-outline-danger delete-billing-btn">
                                                        <i class="ri ri-delete-bin-line"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                ...
                                <tbody id="pricingForms" class="pricing-rows">
                                    ...
                                    <tr class="pricing-row" data-index="{{$key}}">
                                        ...
                                        <td><input type="number" class="form-control"
                                                ...
                                                value="{{$pricingDetails->num_passengers}}"
                                                placeholder="No. of Passengers" min="0"></td>
                                        <td><input type="number" class="form-control"
                                                name="pricing[{{$key}}][gross_price]"
                                                value="{{$pricingDetails->gross_price}}" placeholder="Gross Price"
                                                min="0" step="0.01"></td>
                                        <td><span class="gross-total">0.00</span></td>
                                        <td><input type="number" class="form-control"
                                                name="pricing[{{$key}}][net_price]"
                        ...
                        <div class="card-body p-0">
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="5" data-qualitytype="non_fatal" data-related="CallOpening"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Call Closing" id="CallClosingfareneeds" name="parameters[]"
                                            {{ in_array('Call Closing', $feedbackParameters) ? 'checked' : '' }}>
                                        <label class="form-check-label text-dark" for="CallClosingfareneeds">Call Closing</label>
                                    </div>
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="5" data-qualitytype="non_fatal" data-related="CallClosingfareneeds"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Probing" id="Probing" name="parameters[]"
                                            {{ in_array('Probing', $feedbackParameters) ? 'checked' : '' }}>
                                        <label class="form-check-label text-dark" for="Probing">Probing</label>
                                    </div>
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="5" data-qualitytype="non_fatal" data-related="Probing"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Parapharsing" id="Parapharsing" name="parameters[]"
                                            {{ in_array('Parapharsing', $feedbackParameters) ? 'checked' : '' }}>
                                        <label class="form-check-label text-dark" for="Parapharsing">Parapharsing</label>
                                    </div>
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="5" data-qualitytype="non_fatal" data-related="Parapharsing"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Dead air/Hold" id="DeadAirHold" name="parameters[]"
                                            {{ in_array('Dead air/Hold Procedurefareneeds', $feedbackParameters) ? 'checked' : '' }}>
                                        <label class="form-check-label text-dark" for="DeadAirHold">Dead air/Hold</label>
                                    </div>
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="5" data-qualitytype="non_fatal" data-related="DeadAirHold"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Currency" id="Currency" name="parameters[]"
                                            {{ in_array('Currency', $feedbackParameters) ? 'checked' : '' }}>
                                        <label class="form-check-label text-dark" for="Currency">Currency</label>
                                    </div>
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="5" data-qualitytype="non_fatal" data-related="Currency"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Cold/Blind Transfer" id="ColdBlindTransferfareneeds" name="parameters[]"
                                            {{ in_array('Cold/Blind Transfer', $feedbackParameters) ? 'checked' : '' }}>
                                        <label class="form-check-label text-dark" for="ColdBlindTransferfareneeds">Cold/Blind Transfer</label>
                                    </div>
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="5" data-qualitytype="non_fatal" data-related="ColdBlindTransferfareneeds"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input chkqlty" type="checkbox" role="switch" value="E-Tickets" id="ETicketsfareneeds" name="parameters[]"
                                            {{ in_array('E-Tickets', $feedbackParameters) ? 'checked' : '' }}>
                                        <label class="form-check-label text-dark" for="ETicketsfareneeds">E-Tickets</label>
                                    </div>
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="5" data-qualitytype="non_fatal" data-related="ETicketsfareneeds"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="10" data-qualitytype="non_fatal" data-related="ActiveListening"
                                        name="parameter_notes[Active Listening]" rows="2"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="10" data-qualitytype="non_fatal" data-related="RebuttalsObjectionHandling"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="10" data-qualitytype="non_fatal" data-related="CallHandling"
                                        name="parameter_notes[Call Handling]" rows="2"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="10" data-qualitytype="non_fatal" data-related="SellingSkills"
                                        name="parameter_notes[Selling Skills]" rows="2"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="10" data-qualitytype="non_fatal" data-related="CrossSellingHCIL"
                                        name="parameter_notes[Cross Selling (HCIL)]" rows="2"
                                ...
                                <div class="col-lg-3 col-md-6 col-12">
                                    ...
                                    <textarea class="form-control mt-2 feedback-textarea d-none"
                                        data-marksvalue="10" data-qualitytype="non_fatal" data-related="ItineraryRecappingCallSummary"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="HoldProcedure"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="Misrepresentation"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="RudeSarcasticBehaviour"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="ScreenshotOfServicesProvided"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="MerchantName"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="SplitCharges"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="SuspiciousCustomer"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="ForceSell"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="FakeUnethicalSell"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="ServiceNotProvided"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="CallBackNumberExtension"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="FollowUp"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="ConfirmationSale"
                                        ...
                                        <div class="col-lg-3 col-md-6 col-12">
                                            ...
                                            <textarea class="form-control mt-2 feedback-textarea d-none"
                                                data-marksvalue="0" data-qualitytype="fatal" data-related="Documentation"
...
<!-- Modal -->
<div class="modal fade bank-details" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
