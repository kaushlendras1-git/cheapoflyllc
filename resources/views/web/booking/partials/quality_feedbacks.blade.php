...
@endif    
    <div class="card p-4 show-booking-card" style="font-size: 12px;">
        <div class="d-flex justify-content-between align-items-center mb-1">
            ...
            <button id="saveFeedback" type="button" class="btn btn-primary save-feedback-btn">Save Feedback</button>
        </div>
            ...
            <div class="">
                <div class="switch-container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Probing"
                                    id="Probing" name="parameters[]"
                                    {{ in_array('Probing', $feedbackParameters) ? 'checked' : '' }}>
                                <label class="form-check-label text-dark" for="Probing">Probing</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="5"
                                data-qualitytype="non_fatal" data-related="Probing" name="parameter_notes[Probing]"
                                rows="2"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Currency"
                                    id="Currency" name="parameters[]"
                                    {{ in_array('Currency', $feedbackParameters) ? 'checked' : '' }}>
                                <label class="form-check-label text-dark" for="Currency">Currency</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="5"
                                data-qualitytype="non_fatal" data-related="Currency" name="parameter_notes[Currency]"
                                rows="2"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch"
                                    value="Cold/Blind Transfer" id="ColdBlindTransferfareneeds" name="parameters[]"
                                    {{ in_array('Cold/Blind Transfer', $feedbackParameters) ? 'checked' : '' }}>
                                <label class="form-check-label text-dark" for="ColdBlindTransferfareneeds">Cold/Blind
                                    Transfer</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="5"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch" value="E-Tickets"
                                    id="ETicketsfareneeds" name="parameters[]"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="10"
                                data-qualitytype="non_fatal" data-related="ActiveListening"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="10"
                                data-qualitytype="non_fatal" data-related="RebuttalsObjectionHandling"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="10"
                                data-qualitytype="non_fatal" data-related="CallHandling"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="10"
                                data-qualitytype="non_fatal" data-related="SellingSkills"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            ...
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="10"
                                data-qualitytype="non_fatal" data-related="CrossSellingHCIL"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch"
                                    value="Itinerary Recapping/Call Summary" id="ItineraryRecappingCallSummary"
                                    name="parameters[]"
                                    {{ in_array('Itinerary Recapping/Call Summary', $feedbackParameters) ? 'checked' : '' }}>
                                <label class="form-check-label text-dark" for="ItineraryRecappingCallSummary">Itinerary
                                    Recapping/Call
                                    Summary</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="10"
                                data-qualitytype="non_fatal" data-related="ItineraryRecappingCallSummary"
                        ...
                        <!-- Non-Fatal Section -->
                        <div class="col-12">
                            <h5 class="text-danger mb-1">Fatal</h5>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch"
                                    value="Rude/Sarcastic behaviour" id="RudeSarcasticBehaviour" name="parameters[]"
                                    {{ in_array('Rude/Sarcastic behaviour', $feedbackParameters) ? 'checked' : '' }}>
                                <label class="form-check-label text-dark" for="RudeSarcasticBehaviour">Rude/Sarcastic
                                    behaviour</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="0"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch"
                                    value="Screenshot of services provided" id="ScreenshotOfServicesProvided"
                                    name="parameters[]"
                                    {{ in_array('Screenshot of services provided', $feedbackParameters) ? 'checked' : '' }}>
                                <label class="form-check-label text-dark" for="ScreenshotOfServicesProvided">Screenshot
                                    of services
                                    provided</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="0"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label text-dark" for="SuspiciousCustomer">Suspicious
                                    Customer</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="0"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Force Sell"
                                    id="ForceSell" name="parameters[]"
                                    {{ in_array('Force Sell', $feedbackParameters) ? 'checked' : '' }}>
                                <label class="form-check-label text-dark" for="ForceSell">Force Sell</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="0"
                                data-qualitytype="fatal" data-related="ForceSell" name="parameter_notes[Force Sell]"
                                rows="2"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label text-dark" for="FakeUnethicalSell">Fake/Unethical
                                    Sell</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="0"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch"
                                    value="Call Back Number/Extension" id="CallBackNumberExtension" name="parameters[]"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                <input class="form-check-input chkqlty" type="checkbox" role="switch" value="Follow Up"
                                    id="FollowUp" name="parameters[]"
                                    {{ in_array('Follow Up', $feedbackParameters) ? 'checked' : '' }}>
                                <label class="form-check-label text-dark" for="FollowUp">Follow Up</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="0"
                                data-qualitytype="fatal" data-related="FollowUp" name="parameter_notes[Follow Up]"
                                rows="2"
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label text-dark" for="ConfirmationSale">Confirmation
                                    Sale</label>
                            </div>
                            <textarea class="form-control mt-2 feedback-textarea d-none" data-marksvalue="0"
                ...
                <div class="table-responsive">
                    <table id="booking_feed_back_table" class="table table-bordered align-middle"
                        ...
                        <thead class="table-primary text-center">
                            <tr>
                                <th
                                    style="width: 25%;border: none !important;background-color: #3569df;font-size: 14px;text-align: center;border-radius: 6px;color: #fff;padding: 20px 10px !important;">
                                    Quality strategies</th>
                                <th
                                    style="width: 25%;border: none !important;background-color: #273960;font-size: 14px;text-align: center;border-radius: 6px;color: #fff;padding: 20px 10px !important;">
                                    Comment</th>
                                <th
                                    style="width: 25%; border: none !important; background-color: #00a5fe; font-size: 14px; text-align: center; border-radius: 6px; color: #fff; padding: 20px 10px !important;">
                                    Agent</th>
                                <th
                                    style="width: 25%; border: none !important; background-color: #fda305; font-size: 14px; text-align: center; border-radius: 6px; color: #fff; padding: 20px 10px !important;">
                                    Date</th>
                            </tr>
                        </thead>
                        <tbody>
