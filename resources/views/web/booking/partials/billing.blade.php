       ...
       @if(auth()->user()->role != 'billing')
        ...
        <div class="card p-4 mt-4 show-booking-card">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-header border-0 p-0 detail-passanger">Card Details <span style="color:red"> (Billing Details must be entered before adding Card Details.) </span> </h5>
                        ...
                        <table id="billingTable" class="table">
                            ...
                            <tbody id="billingForms">
                                ...
                                <tr class="billing-card" data-index="{{$key}}">
                                    ...
                                    <td>
                                        <select class="form-control w-100" name="billing[{{$key}}][card_type]">
                                    ...
                                    <td>
                                        ...
                                        <input value="{{$billingDetails['amount']??0}}" name="billing[{{$key}}][amount]"
                                            class="finalAmount" type="hidden" />
                                    </td>
