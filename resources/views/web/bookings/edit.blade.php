...
@section('content')
<form id="bookingForm" action="{{ route('travel.bookings.submit') }}" method="POST" novalidate>
    @csrf
    <!-- Content -->
            ...
            <div class="card p-4 mb-4">
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="pnr" value="{{$booking->pnr}}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Hotel Ref</label>
                        <input type="text" class="form-control" name="hotel_ref" value="{{$booking->hotel_ref}}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Cruise Ref</label>
                        <input type="text" class="form-control" name="cruise_ref" value="{{$booking->cruise_ref}}">
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="phone" value="{{$booking->phone}}" required>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="query_type" value="{{$booking->query_type}}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Company Organisation</label>
                        <input type="text" class="form-control" name="company_organisation" value="{{$booking->company_organisation}}" >
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="reservation_source" value="{{$booking->reservation_source}}" >
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Descriptor</label>
                        <input type="text" class="form-control" name="descriptor" value="{{$booking->descriptor}}" >
                    </div>
                    <div class="col-md-3">
                        ...
                        <div id="passengerForms">
                            ...
                            <div class="row mb-5 mt-2 passenger-form" data-index="0">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="passenger_type[]" value="Adult">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Gender</label>
                                    <input type="text" class="form-control" name="passenger_gender[]" value="Male">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">DOB</label>
                                    <input type="date" class="form-control" name="passenger_dob[]" value="2025-04-10">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Seat</label>
                                    <input type="text" class="form-control" name="passenger_seat_number[]" placeholder="Seat">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Title</label>
                                    <input type="text" class="form-control" name="passenger_title[]" value="Ms">
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Credit Note Amount</label>
                                    <input type="number" class="form-control" name="passenger_credit_note[]" value="0" step="0.01">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">First Name</label>
                                    <input type="text" class="form-control" name="passenger_first_name[]" value="mnnfksdfs fsdjfds">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Middle Name</label>
                                    <input type="text" class="form-control" name="passenger_middle_name[]" placeholder="Middle Name">
                                </div>
                                <div class="col-md-3 position-relative">
                                    <label class="form-label">Last Name</label>
                                    <input type="text" class="form-control" name="passenger_last_name[]" value="cshcjxhds">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">E-Ticket</label>
                                    <input type="text" class="form-control" name="passenger_e_ticket_number[]" placeholder="E Ticket">
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between mt-4">
                    ...
                    <div class="card p-4">
                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="row g-3 billing-card" data-index="0">
                                ...
                                <div class="col-md-3">
                                    <input type="text" class="form-control" placeholder="Contact No" name="billing_contact_no[]">
                                </div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" placeholder="City" name="billing_city[]">
                                </div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" placeholder="Country" value="Afghanistan" name="billing_country[]">
                                </div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" placeholder="State" value="Badakhshan" name="billing_state[]">
                                </div>
                                <div class="col-md-2">
                                    <input type="text" class="form-control" placeholder="ZIP Code" name="billing_zip_code[]">
                                </div>
                                <div class="col-md-1">
                                    <input type="text" class="form-control" placeholder="Currency" value="USD" name="billing_currency[]" required>
                                </div>
                                <div class="col-md-1">
                                    <input type="number" class="form-control" placeholder="0.00" name="billing_amount[]" value="0" step="0.01" required>
                                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" name="hotel_cost" value="{{$pricing->hotel_cost ?? ''}}" placeholder="0.00" step="0.01" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Cruise Cost ($)<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="cruise_cost" value="{{$pricing->cruise_cost ?? ''}}" placeholder="0.00" step="0.01" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Total Amount ($)<span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="total_amount" value="{{$pricing->total_amount ?? ''}}" placeholder="0.00" step="0.01" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Advisor MCO ($)</label>
                                    <input type="number" class="form-control" name="advisor_mco" value="{{$pricing->advisor_mco ?? ''}}" placeholder="0.00" step="0.01">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Conversion Charge ($)</label>
                                    <input type="number" class="form-control" name="conversion_charge" value="{{$pricing->conversion_charge ?? ''}}" placeholder="0.00" step="0.01">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Airline Commission ($)</label>
                                    <input type="number" class="form-control" name="airline_commission" value="{{$pricing->airline_commission ?? ''}}" placeholder="0.00" step="0.01">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Final Amount ($)</label>
                                    <input type="number" class="form-control" name="final_amount" value="{{$pricing->final_amount ?? ''}}" placeholder="0.00" step="0.01">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Merchant</label>
                                    <input type="text" class="form-control" name="merchant" value="{{$pricing->merchant ?? ''}}" placeholder="Merchant Name">
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Net MCO ($)</label>
                                    <input type="number" class="form-control" name="net_mco" value="{{$pricing->net_mco ?? ''}}" placeholder="0.00" step="0.01">
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between mt-4">
