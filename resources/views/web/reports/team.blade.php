                ...
                <form method="GET" action="{{ route('reports.team') }}">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <div class="add-follow-btn export-btn">
                            <a data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Export To Excel" href="{{ route('reports.team.export', request()->query()) }}" class="btn btn-success px-4 py-3 gap-1 w-auto button-style">
