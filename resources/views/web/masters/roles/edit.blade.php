    ...
    <div class="lob-header d-flex align-items-center justify-content-between">
        <div>
            <h2 class="lob-title mb-1">
                <span class="iconify" data-icon="mdi:shield-account-cog-outline"
            ...
            <div class="lob-card p-5">
                <form method="POST" action="{{ route('roles.update', $role->id) }}"
                    ...
                    <div class="row g-4 align-items-end">
                        ...
                        <div class="col-md-3 position-relative">
                            <div class="floating-group lob-card">
                                <input type="text" name="name" id="roleName" class="form-control input-style w-100"
                                    placeholder=" " value="{{ old('name', $role->name) }}" required>
                            ...
                            <div class="floating-group lob-card">
                                <select name="department_id" id="roleDepartment" class="form-control input-style w-100"
                                    ...
                                    <option value="" disabled
                                        {{ old('department_id', $role->department_id) ? '' : 'selected' }}>Select
                                        Department</option>
                        ...
                        <div class="col-md-3 position-relative">
                            <div class="floating-group lob-card">
                                <select name="status" id="roleStatus" class="form-control input-style w-100" required>
                                    <option value="1" {{ old('status', $role->status) == 1 ? 'selected' : '' }}>✅ Active
                                    </option>
