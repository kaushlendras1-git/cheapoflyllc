        ...
        <tbody>
            ...
            <tr>
                <td style="font-size: 16px; font-weight: 600; text-align: center; padding: 0px 0px 0px 30px;">
                        ...
                        <span style="font-size: 14px; font-weight: 400; display: block; color: #000; padding-top: 10px;">{{ $booking->pnr }}</span></span>
                </td>
                ...
                <td colspan="2" style="padding: 30px 30px 0px 30px;">
                    <div style="border: 2px solid #c53d3d; border-radius: 10px; border-collapse: collapse; overflow: hidden;">
                        ...
                        @foreach($booking->travelCar as $key=>$travelCar)
                               <tr>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$travelCar->car_rental_provider}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$travelCar->car_type}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$travelCar->pickup_location}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$travelCar->dropoff_location}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$travelCar->pickup_date?->format('Y-m-d')}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$travelCar->pickup_time}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$travelCar->dropoff_date?->format('Y-m-d')}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$travelCar->dropoff_time}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$travelCar->confirmation_number}}</td>
                ...
                <td colspan="2" style="padding: 30px 30px 0px 30px;">
                    <div style="border: 2px solid #c53d3d; border-radius: 10px; border-collapse: collapse; overflow: hidden;">
                        ...
                        @foreach($booking->trainBookingDetails as $key=>$trainBookingDetails)
                            <tr>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->direction}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->departure_date?->format('Y-m-d')}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->train_number}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->cabin}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->departure_station}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->departure_hours}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->arrival_station}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->arrival_hours}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->duration}}</td>
                                <td style="font-size: 12px; font-weight: 400; text-align: center; color: #000; padding: 10px 10px;">{{$trainBookingDetails->transit}}</td>
