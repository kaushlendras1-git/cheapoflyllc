                        ...
                        <td>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr style="background: #e9ebf1;">
                                    ...
                                    <td style="font-size: 14px; padding: 10px; border: 1px solid #ddd; font-weight: bold;">{{ $user->name ?? 'Gordon Scott Mcknight' }}</td>
                                </tr>
                                <tr>
                                    <td style="font-size: 14px; padding: 10px; border: 1px solid #ddd; background: #e9ebf1;">Email</td>
                                    <td style="font-size: 14px; padding: 10px; border: 1px solid #ddd; font-weight: bold;">{{ $user->email ?? 'maryann.guitar@yahoo.ca' }}</td>
                                </tr>
                                <tr style="background: #e9ebf1;">
                                    <td style="font-size: 14px; padding: 10px; border: 1px solid #ddd;">Booking Date</td>
                                    <td style="font-size: 14px; padding: 10px; border: 1px solid #ddd; font-weight: bold;">{{ $booking->date ?? 'Sunday, Jun 29, 2025' }}</td>
                                </tr>
                                <tr>
                                    <td style="font-size: 14px; padding: 10px; border: 1px solid #ddd; background: #e9ebf1;">Airline Ref</td>
                                    <td style="font-size: 14px; padding: 10px; border: 1px solid #ddd; font-weight: bold;">{{ $booking->airline_ref ?? '4QO44P/4QNGLG' }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="font-size: 14px; padding: 10px; border: 1px solid #ddd;">{{ $passenger->name ?? 'Mary Ann Mcknight' }}</td>
                                    <td style="font-size: 14px; padding: 10px; border: 1px solid #ddd;">{{ $passenger->type ?? 'Adult' }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="margin-top: 10px; border: 1px solid #ddd;">
                    ...
                    <tr>
                        <td style="padding: 10px;">
                            <img src="{{ $itinerary->image1 ?? 'http://www.cheapoflyllc.com/images/F/29062025120225.png' }}" alt="Itinerary Image 1" style="max-width: 100%; height: auto; display: block;">
                            <img src="{{ $itinerary->image2 ?? 'http://www.cheapoflyllc.com/images/F/29062025120642.png' }}" alt="Itinerary Image 2" style="max-width: 100%; height: auto; display: block; margin-top: 10px;">
                        </td>
                    </tr>
                </table>
</body>
...
<div class="container mt-5">
    ...
    <div class="text-center my-3">
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#signatureModal">Add Signature</button>
    </div>
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs" id="signatureTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="draw-tab" data-bs-toggle="tab" data-bs-target="#draw" type="button" role="tab" aria-controls="draw" aria-selected="true">Draw</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="type-tab" data-bs-toggle="tab" data-bs-target="#type" type="button" role="tab" aria-controls="type" aria-selected="false">Type</button>
                    </li>
                </ul>
