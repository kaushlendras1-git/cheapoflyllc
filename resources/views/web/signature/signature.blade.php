        ...
        <thead>
            <tr>
                ...
                <th style="padding: 10px 30px 10px 0px;"> 
                  Speak to a travel Expert  <span style="display: flex; align-items: center; justify-content: end;"><img
            ...
            <tr>
                <td colspan="2" style="padding: 0px;"> 
                    @if($bookingTypes[0] == 'Flight')
                        <img style="height: 300px; width: 100%; " src="{{asset('email-templates/flight-banner.png')}}" alt="flight">
                                    ...
                                    <td colspan="2" style="padding: 30px 30px 0px 30px;">
                                      ...
                                      <table style="width:100%; max-width:600px; margin:0 auto; border-collapse:collapse;">
                                         @foreach($booking->travelFlight as $index => $flight)
                                            <tr style="display:flex; flex-direction:column; margin-bottom:16px;">
                                                <td style="display:flex; align-items:center; text-align:left;">
                                                    <div style="align-items:center; display:flex; margin-right:10px; margin-bottom:16px;">
                                                        <img src="https://www.pnrconverter.com/images/airlines/png/150/nz.png" alt="airline logo" style="max-height:35px; object-fit:scale-down; width:75px;" width="75">
                                                    </div>
                                                    <div style="text-align:left; flex:1;">
                                                        <p style="margin:0px; padding:0px; font-weight:bold;">
                                                            {{ $flight->departure_date?->format('D, M j') }} - {{$flight->airline_code}} {{$flight->flight_number}} <span style="text-transform:capitalize;"></span>- {{$flight->duration}}
                                                        </p>
                                                        <p style="margin:0px; padding:0px;">
                                                            Departing: {{$flight->departure_hours}} from {{$flight->departure_airport}}<br>
                                                            Arriving: {{$flight->arrival_hours}} into {{$flight->arrival_airport}}
                                                        </p>
                                                        @if($flight->transit)
                                                            <div style="color:rgb(136, 136, 136); font-size:12px; line-height:16px; margin-bottom:5px; margin-top:5px; text-align:left;">
                                                                <div>
                                                                    --------<span style="color:red; font-weight:600;"></span>--Transit Time: {{$flight->transit }} --------
                                                                </div>
                                                            </div>
                                                        @endif    
                            ...
                            <tr>
                                ...
                                <td style="width:200px; padding:0; vertical-align:top;">
                                    <img src="{{asset('email-templates/bedroom.jpg')}}" alt="Hotel"
                                        style="width:200px; height:150px; border-top-left-radius:12px;margin-bottom:10px">
                                     <img src="{{asset('email-templates/bedroom.jpg')}}" alt="Hotel"
                                        style="width:200px; height:150px; border-top-left-radius:12px;">    
                                </td>

                                <td style="padding:12px; padding-left: 30px; vertical-align:top;">
                                    <p style="margin:4px 0; font-size:13px; color:#555;"> <div style="white-space: pre-line;">{{ $booking->hotel_description }}</div></p>
                                ...
                                <td colspan="2"
                                    ...
                                    <table cellspacing="0" cellpadding="6" style="width:100%; font-size:14px; text-align:center;">
                                         @foreach($booking->travelHotel as $key=>$travelHotel)
                                             ...
                                             <tr>
                                                <td>
                                                    <div style="font-size:12px; color:#888; font-weight:bold;">Hotel Name</div>
                                                    <div style="font-weight:bold;">{{$travelHotel->hotel_name}}</div>
                                                </td>

                                                <td>
                                                    <div style="font-size:12px; color:#888; font-weight:bold;">Room Category</div>
                                                    <div style="font-weight:bold;">{{$travelHotel->room_category}}</div>
                                                </td>

                                                <td>
                                                    <div style="font-size:12px; color:#888; font-weight:bold;">Confirmation Number</div>
                                                    <div style="font-weight:bold;">{{$travelHotel->confirmation_number}}</div>
                                                </td>
                                                 
                                                 <td>
                                                    <div style="font-size:12px; color:#888; font-weight:bold;">Hotel Address</div>
                                                    <div style="font-weight:bold;">{{$travelHotel->hotel_address}} </div>
                                                </td>
                                            </tr>    
                                            <tr>  
                                                 <td>
                    ...
                    <table border="1" cellspacing="0" cellpadding="10"
                        ...
                        <tr>
                            <td style="padding:8px;">
                              <b>  {{ \Carbon\Carbon::parse($travelCruise->departure_date)->format('l') }} </b><br>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <p>{!! nl2br(e($addon->service_name)) !!}</p>
                            </td>
                        </tr>
                        @endforeach
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td style="color:#000; padding-bottom:8px;">
                                               <div style="white-space: pre-line;">{{ $booking->car_description }}</div>
                                            </td>
                                        </tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                           ...
                                           @if($travelCar->car_rental_provider)
                                            <p><b>Car Rental Provider</b> : {{$travelCar->car_rental_provider}}</p>          
                                           @endif

                                           @if($travelCar->car_type)
                                             <p><b>Car Type</b> : {{$travelCar->car_type}}</p>  
                                            @endif
                                          
                                            @if($travelCar->confirmation_number)
                                              <p><b>Confirmation Number</b> : {{$travelCar->confirmation_number}}</p>  
                                            @endif
                                         
                                            @if($travelCar->rental_provider_address)
                                                 <p><b>Rental Provider Address</b> : {{$travelCar->rental_provider_address}}</p> 
                                           @endif
                                        ...
                                        <tr>
                                            <td style="font-size:13px; color:#333; line-height:20px; padding-bottom:20px;">
                                                <span style="font-size:14px; display: block;">⭕  {{ $travelCar->pickup_date?->format('D, M j') }} - {{$travelCar->pickup_time}}</span>
                                                <span style="padding-left: 25px; display: block;"> <b>{{$travelCar->pickup_location}}</b> </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:13px; color:#333; line-height:20px;">
                                                <span style="font-size:14px; display: block;">⭕ {{ $travelCar->dropoff_date?->format('D, M j') }} -  {{$travelCar->dropoff_time}}</span>
                                                <span style="padding-left: 25px; display: block;"> <b>{{$travelCar->dropoff_location}}</b> </span>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="font-size:14px; font-weight:bold; color:#003366; padding-bottom:5px;">
                                                Departure : {{ $trainBookingDetails->departure_date ? $trainBookingDetails->departure_date->format('D, M d, Y') : '' }} | Arrival : {{ $trainBookingDetails->departure_date ? $trainBookingDetails->arrival_date->format('D, M d, Y') : '' }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:13px; color:#333; line-height:18px; padding-bottom:10px;">
                                                 <b>Direction</b> : {{$trainBookingDetails->departure_station}} | <b>Cabin</b> : {{$trainBookingDetails->cabin}}
                                            </td>
                                        </tr>
                                        <!-- Route Codes -->
                                        <tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="30%" valign="top" style="text-align:center;">
                                                            <div style="font-size:20px; font-weight:bold;">{{$trainBookingDetails->departure_hours}}</div>
                                                        ...
                                                        <td width="10%" valign="middle"
                                                            ...
                                                            →
                                                            <div style="font-size:11px; color:#666;">{{$trainBookingDetails->transit}}</div>
                                                        </td>
                                                        <!-- Arrives -->
                                                        <td width="30%" valign="top" style="text-align:center;">
                                                            <div style="font-size:20px; font-weight:bold;">{{$trainBookingDetails->arrival_hours}}</div>
                    ...
                    <div
                        ...
                        <table style="width: 100%; border-radius: 10px; border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <th style="font-size: 14px; font-weight: 600; padding: 10px 20px; text-align: right;">Seat</th>
                                <th style="font-size: 14px; font-weight: 600; padding: 10px 20px; text-align: right;">E-Ticket</th>

                            </tr>
                              @foreach($booking->passengers as $key=>$passengers)
                            <tr>
                                <td style="font-size: 16px; font-weight: 400; color: #000; padding: 0px 20px 10px 0px; text-align: right;">{{$passengers->passenger_type}} </td>
                                <td style="font-size: 16px; font-weight: 400; color: #000; padding: 0px 0px 10px 20px; text-align: left;">{{$passengers->title}} {{$passengers->first_name}} {{$passengers->middle_name}} {{$passengers->last_name}} </td>
                                <td style="font-size: 16px; font-weight: 400; color: #000; padding: 0px 20px 10px 0px; text-align: right;">{{$passengers->seat_number}} </td>
                                <td style="font-size: 16px; font-weight: 400; color: #000; padding: 0px 20px 10px 0px; text-align: right;">{{$passengers->e_ticket_number}} </td>
                            </tr>
                            @endforeach
                                ...
                                <td colspan="2">
                                   <h6>Please Note</h6>
                                    <ol>
                                        ...
                                        <li>
                                        Please be informed that your card may be billed with a single authorization of <strong>$0.00 USD</strong>, which may appear on your card statement as <em>Flydreams</em>, <em>FareTicketsLLC</em>, or <em>Cruiseline Service</em>.
                                        </li>
                                    </ol>
                                    <p><strong>Prices are not guaranteed</strong> until the ticket number(s) are issued. Prices may change based on airline inventory availability.</p>
                                </td>
                            </tr>
