    ...
    <div class="main-container">
            ...
            <tr>
                <td style="background-color: #ffffff; padding: 0;">
                    ...
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/flight-banner.png')}}" alt="flight">
                    @elseif($bookingTypes[0] == 'Cruise')
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/cruise-banner.png')}}" alt="cruise">
                    @elseif($bookingTypes[0] == 'Train')
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/train-banner.png')}}" alt="amtrak">
                    @elseif($bookingTypes[0] == 'Car')
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/car-banner.png')}}" alt="car">
                    @elseif($bookingTypes[0] == 'Hotel')
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/hotel-banner.png')}}" alt="hotel">
                    @endif
                    @else
                    @if($bookingTypes[0] == 'Flight')
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/flight_banner.png')}}" alt="flight">
                    @elseif($bookingTypes[0] == 'Cruise')
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/cruise_banner.png')}}" alt="cruise">
                    @elseif($bookingTypes[0] == 'Train')
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/train_banner.png')}}" alt="amtrak">
                    @elseif($bookingTypes[0] == 'Car')
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/car_banner.png')}}" alt="car">
                    @elseif($bookingTypes[0] == 'Hotel')
                    <img style="display: block; width: 100%; height: auto; max-height: 250px;"
                        src="{{public_path('email-templates/hotel_banner.png')}}" alt="hotel">
                    @endif
                    @endif
                </td>
            </tr>
                        ...
                        <table width="100%">
                            <tr>
                                <td width="40" style="padding-right: 10px; vertical-align: middle;">
                                    <div style="margin-left: 60px;">
                                        <img width="28" height="28"
                                            src="{{ public_path('email-templates/calendar.png') }}" alt="Date"
                                            style="display: block;">
                                    </div>
                                </td>
                                <td style="vertical-align: middle;">
        ...
        <div class="section" style="page-break-inside: avoid;">
            <div class="section-header"
                style="background: #1e3a8a; color: #fff; font-weight: 600; padding: 8px 12px; border-radius: 4px 4px 0 0;">
                Flight Details :-
            </div>

            <div class="section-content"
                style="background: #ffffff; padding: 12px; border: 1px solid #e5e7eb; border-top: none;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="vertical-align: top; padding-left: 8px;">
                            <div
                                style="font-size: 13px; font-weight: 600; color: #0f172a; line-height: 1.4; margin-bottom: 2px; margin-left: -250px;">
                                {{ $flight->departure_date?->format('D, M j') }} -
                                {{ $flight->airline_code }} {{ $flight->flight_number }} -
                                {{ $flight->duration }}
                            </div>
                            <div style="font-size: 12px; color: #4a5568; line-height: 1.4; margin-left: -250px;">
                                <strong style="font-weight: 600; color: #0f172a;">Departing:</strong>
                                {{ date('h:i A', strtotime($flight->departure_hours)) }}
                                from {{ $flight->departure_airport }}
                            </div>
                            <div style="font-size: 12px; color: #4a5568; line-height: 1.4; margin-left: -250px;">
                                <strong style="font-weight: 600; color: #0f172a;">Arriving:</strong>
                                {{ date('h:i A', strtotime($flight->arrival_hours)) }}
                                into {{ $flight->arrival_airport }}
                            </div>
                            @if($flight->transit && $flight->transit != '00:00')
                            <div style="font-size: 12px; color: #718096; padding-top: 4px; margin-left: -250px;">
                    ...
                    <tr>
                        <td colspan="2" style="padding: 10px 0;">
                            <div style="width: 90%; margin: 0 auto; border-top: 1px dashed #cbd5e0; opacity: 0.9;">
                            </div>
                        </td>
                    </tr>
                    @endif
                    ...
                    <div style="padding-top: 10px;">
                        <table width="100%"
                            ...
                            <tr>
                                ...
                                <td width="60%" style="color: #0f172a; padding: 4px 8px; border: 1px solid #e9ecef;">
                                    {{ $travel_cruise_data->cruise_line ?? '' }}
                                </td>
                            </tr>
                            <tr>
                                <td width="40%"
        ...
        <div class="section">
            ...
            <div class="section-content">
                ...
                <div style="margin-bottom: 15px; padding-bottom: 10px; border-bottom: 1px solid #e9ecef;">
                    ...
                    <!-- Train + Times -->
                    <div
                        style="padding: 20px 0; font-size: 12px; color: #4a5568; background-color: #f8f9fa; border-radius: 4px; margin-top: 10px;">
                        <table width="100%">
                            <tr>
                                <!-- Train Number -->
                                <td width="25%" style="text-align: center; vertical-align: middle;">
                                    ...
                                    <div style="font-size: 16px; font-weight: bold; color: #0f172a;">
                                        {{ $trainBookingDetails->train_number }}
                                    </div>
                                    <div style="font-size: 12px; color: #718096">Train Number</div>
                                </td>
                                <!-- Departure Time -->
                                <td width="25%" style="text-align: center;">
                                    ...
                                    <div style="font-size: 12px; color: #718096;">Departure Time</div>
                                </td>
                                <!-- Duration -->
                                <td width="25%" style="text-align: center; ">
                                    <div style="font-size: 16px; font-weight: bold; color: #0f172a;">
                                ...
                                <td width="25%" style="text-align: center; ">
                                    ...
                                    <div style="font-size: 11px; color: #718096;">Arrival Time</div>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            <div style="padding: 10px 12px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, Arial, sans-serif;">
                ...
                <div
                    ...
                    <ul style="margin: 0; padding-left: 15px; list-style-type: disc;">
                        <li>
                            <strong>All transactions</strong> will be processed in US Dollars (USD). If your card
                            was
                            issued in a country other than the USA, your card issuer may charge a currency
                            conversion
                            fee of up to 4% of the total amount charged. Kindly check with your financial
                            institution
                            for more information.
                        </li>
                        <li>
                            <strong>Prices are not guaranteed</strong> until the ticket number(s) are issued. Prices
                            may
            ...
            <div style="padding: 10px 12px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, Arial, sans-serif;">
                <div style="font-size: 12px; color: #4a5568; line-height: 1.6;">
                    ...
                    <p style="margin: 0 0 10px;">
                        ...
                        accuracy of the itinerary, including all passenger names, flight schedules, dates, and
                        times.
                    </p>
                    ...
                    <p style="margin: 0 0 10px;">
                        ...
                        through
                        <strong>single or multiple transactions</strong>. I understand that, regardless of the
                        number of
                    ...
                    <p style="margin: 0 0 10px;">
                        I further acknowledge that the charges may appear on my credit card statements under one or
                        more
                    ...
                    <p style="margin: 0 0 10px;">
                        ...
                        <strong>{{ $booking->selected_company_name }}</strong> and its affiliated service providers
                        to
        ...
        <div style="background-color: #ffffff; padding: 0;">
            <div style="background: #1c316d; padding: 5px; text-align: center; border-radius: 4px;">
