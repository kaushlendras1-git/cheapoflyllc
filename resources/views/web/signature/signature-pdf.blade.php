            ...
            <tr>
                <td style="background-color: #ffffff; padding: 0;">
                    @if($bookingTypes[0] == 'Flight')
                        <img src="{{ public_path('email-templates/flight_banner.png') }}" alt="Flight"
                            style="display: block; width: 100%; height: auto; max-height: 250px;">
                    @elseif($bookingTypes[0] == 'Cruise')
                        <img src="{{ public_path('email-templates/cruise_banner.png') }}" alt="Cruise"
                            style="display: block; width: 100%; height: auto; max-height: 250px;">
                    @elseif($bookingTypes[0] == 'Train')
                        <img src="{{ public_path('email-templates/train_banner.png') }}" alt="Train"
                            style="display: block; width: 100%; height: auto; max-height: 250px;">
                    @elseif($bookingTypes[0] == 'Car')
                        <img src="{{ public_path('email-templates/car_banner.png') }}" alt="Car"
                            style="display: block; width: 100%; height: auto; max-height: 250px;">
                    @elseif($bookingTypes[0] == 'Hotel')
                        <img src="{{ public_path('email-templates/hotel_banner.png') }}" alt="Hotel"
                            style="display: block; width: 100%; height: auto; max-height: 250px;">
                    @endif
                </td>
            </tr>
